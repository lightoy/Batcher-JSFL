 ...
 *
 * 1.get the bitmap files 
 * 2.set bitmap files' compression type to lossless,check allowSmoothing
 * 3.export In first frame and the basis class is BitmapData，class name is the picture file's name
